...
# Add meta 
# changed dir to my folder instead of pulling from the main reproducible code folder bc that couldnt be downloaded 
# so i had to download files individually and create folders individually
...
# changed 3 into c3, 0 to c0 bc those are the name in levels(Idents(epitrace_obj_age_estimated_multiome))
...
# ── 1. Scatter: original vs balanced age per shared cell ────────────────────
...
# ── 2. Figure 6i equivalent: violin per cell type, both runs side by side ───
...
# ── 3. Figure 6g/6h equivalent: nIPC NR2F1+ vs LMO3+ ───────────────────────
...
# ── 4. Figure 6j equivalent: phylogeny tree on balanced object ───────────────
...
# ── 5. New: scatter summary ──────────────────────────────────────────────────

pdf('/projectnb/ds596/students/jishan/Plots/Comparison_Scatter_Age_Original_vs_Balanced.pdf',
    height = 5, width = 6)
print(p_scatter)
dev.off()

message("All comparison plots saved.")
